            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5 me-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_2">Instalaciones</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_3">Quienes somos</a>
                        </li>
        ...
        <section class="explore-section section-padding" id="section_2">
            <div class="container">
                ...
                <div class="col-12 text-center">
                    <h2 class="mb-4">Instalaciones</h1>
                </div>
        ...
        <section class="timeline-section section-padding" id="section_3">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 text-center">
                        <h2 class="text-white mb-4">¿Quienes somos?</h1>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-12 mb-4 mb-lg-0">
                        <iframe class="google-map" src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d1881.1599416754464!2d-99.2063243!3d19.4417704!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2smx!4v1690270726520!5m2!1ses!2smx"" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
